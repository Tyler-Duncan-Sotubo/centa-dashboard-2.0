...
import PushNotification from "../../navigation/PushNotification";
    ...
    >
      <div className="flex justify-between items-center h-full w-full md:px-6">
        <Input
          type="search"
          placeholder="Search..."
          className="w-1/2 min-w-[600px] bg-sidebar text-textPrimary placeholder:text-textSecondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-opacity-50 border-none"

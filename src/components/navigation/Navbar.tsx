      ...
      <div className="flex items-center justify-between h-full px-4 md:px-4">
        ...
        <nav className="hidden md:flex">
          <Input
            type="search"
            placeholder="Search..."
            className="w-full min-w-[600px] bg-sidebar text-textPrimary placeholder:text-textSecondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-opacity-50 border-none"

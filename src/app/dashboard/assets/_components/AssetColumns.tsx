...
import { calculateDepreciatedValue } from "@/utils/calculateDepreciatedValue";
import { AssetDetailSheet } from "./AssetDetails";
...
import AssignAssignModal from "./AssignAssignModal";
  ...
  },
  {
    ...
    cell: ({ row }) =>
      row.original.employeeId ? (
        ...
        <AssignAssignModal id={row.original.id} />
      ),
  },
  {

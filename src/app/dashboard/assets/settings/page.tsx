...
// These can be shared config for multiple modules
const approverRoles = [
...
export default function AssetApprovalSettings() {
  ...
  const fetchSettings = async () => {
    const res = await axiosInstance.get("/api/asset-settings");
  ...
  const updateSetting = async (
    ...
    try {
      await axiosInstance.patch("/api/asset-settings/update-asset-setting", {
        key,
        value,
      });
      toast({

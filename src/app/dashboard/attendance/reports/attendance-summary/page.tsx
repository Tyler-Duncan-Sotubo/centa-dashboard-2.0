...
import { MonthlySummaryColumns } from "./_components/MonthlySummaryColumns";
...
import { DashboardAttendanceSummary } from "./_components/DashboardAttendanceSummary";
...
const AttendanceReportPage = () => {
  ...
  const { dailySummary, monthlySummary } = data ?? {};
      ...
      <div className="mt-10 px-5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-between space-x-3">
            {YearSelector()}
            <ExportButton
              endpoint="gen-monthly-attendance-summary"
              yearMonth={yearMonth}
            />
          </div>
        </div>
        <DataTable columns={MonthlySummaryColumns} data={monthlySummary} />
      </div>
    </div>
  );
};
